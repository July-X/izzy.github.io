...
**关键洞察**：升级组合是乘法关系，不是加法！这意味着策略性——玩家需要选择升级哪个属性。
...
**线性增长 vs 指数增长**：这里选择线性（+0.5/次），而不是指数。原因：
...
**保留什么？** 只保留`prestigeLevel`和`prestigeMult`。这是核心设计：
...
**关键信息**：立即显示新倍率和重置后的速率。玩家能直观感受到“重生后产出从1.0/秒变成1.5/秒”。
