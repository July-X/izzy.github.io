---
title: "可视化面板大改：动态玩家管理、环形拓扑与 INP 优化"
...
上一篇写了 Flow 粒子动画的实现。这一篇记录可视化面板的后续大改——从固定 5 玩家到动态玩家管理，从底部单侧 port 到四边环绕 port，以及一次关键的 INP 性能修复。
...
这是这次改动里最关键的修复。之前点击"发送"按钮后，界面卡死 30 秒以上才能操作。
...
下一步打算做什么？可能是接入真实的多人联机数据做压力测试，或者加 Prometheus 指标监控。你觉得还有什么值得加？
